...
import hw13.Exceptions.MinusAgeException;
import hw13.Exceptions.WrongIdException;
import hw13.Human.Human;
import hw13.Human.Man;
import hw13.Human.Woman;
import hw13.Pet.Pet;
import hw13.Random.genRan;
...
public class FamilyController {
    ...
    public void getFamilyById() {
        ...
        int id = new Scanner(System.in).nextInt();
            System.out.println(familyService.getFamilyById(id).map(Family::prettyFormat).orElseThrow(WrongIdException::new));
        }
        catch (Exception e){
    ...
    public void bornChild(){
        try{
            ...
            if(familyService.getFamilyById(id).orElseThrow(WrongIdException::new).countMembers()>6)
